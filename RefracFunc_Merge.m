...
function [XintersectionMatrix,YintersectionMatrix,IntMatrix,angMatrix] = ...
    ...
    lensType,ecc,bEll,h,k,radFace,polAng,imCoordx,imCoordy,imangles,theta,r4)
...
%flexidose image
                        type=1;
                        [IntM] = Image(type,r4,IntMatrix(i,5),i,ray,imCoordx,imCoordy,scale,imangles,xint,yint,aRef,det,r1,theta,h,k);
                        IntMatrix(i,5)=IntM;
